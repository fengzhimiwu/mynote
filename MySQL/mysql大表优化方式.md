...
- 支持外键
- 支持崩溃后的安全恢复
- 不支持全文索引 总体来讲，MyISAM适合`SELECT`密集型的表，而InnoDB适合`INSERT`和`UPDATE`密集型的表
...
![img](https://upload-images.jianshu.io/upload_images/1736439-453dda3bf4b338d7?imageMogr2/auto-orient/strip|imageView2/2/w/505/format/webp)
...
链接：https://www.jianshu.com/p/1bf3196ad1ac